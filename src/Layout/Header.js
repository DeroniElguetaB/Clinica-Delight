...
import { MenuSelect } from '../components/ModeloFormularios/Form';
import { TbUser } from 'react-icons/tb';
import { AiOutlinePoweroff } from 'react-icons/ai';
import { useNavigate } from 'react-router-dom';
import { BiMenu } from 'react-icons/bi';
import MenuDrawer from '../components/BarraMenu/MenuDrawer';
            ...
            <div className=" items-center md:flex hidden">
              <MenuSelect datas={DropDown1}>
                <div className="flex gap-4 items-center p-4 rounded-lg">
                  ...
                  />
                  <p className="text-sm text-textGray font-medium">Dr. Duran</p>
                </div>
              </MenuSelect>
            </div>
          </div>
